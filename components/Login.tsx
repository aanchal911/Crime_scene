...
const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="w-full animate-fade-in max-w-md mx-auto">
      {/* Terminal Header */}
      <div className="bg-zinc-900 border-x border-t border-zinc-700 p-2 flex items-center gap-2 rounded-t-sm">
      ...
      <div className="bg-black/80 border border-zinc-700 p-8 rounded-b-sm shadow-2xl backdrop-blur-md">
        <div className="flex flex-col items-center mb-8 border-b border-zinc-800 pb-6">
            <div className="p-3 bg-zinc-900 rounded-full border border-zinc-700 mb-4 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
            ...
            <p className="text-zinc-600 text-xs font-mono">AUTHORIZED PERSONNEL ONLY</p>
        </div>
      ...
      <div className="mt-8 border border-zinc-800 bg-zinc-900/50 p-4 rounded-sm">
